  ...
  return (
    <>
      <Container>
        ...
        <FeatureDesc>
          {" "}
          Meal prep your work week with coordinated delivery and a range of
          options
        </FeatureDesc>
        <FeatureDesc>
          {" "}
          Taste dishes you won't find in the restaurant, and from every corner
          of the Globe{" "}
        </FeatureDesc>
        <FeatureDesc>
          {" "}
          Learn about Boston's diversity and connect with your neighbors
        </FeatureDesc>
      </Container>
    </>
  );
